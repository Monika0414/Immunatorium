...
## ignored. Reuses CircleShape for its body, so no art is needed. This is the
## primary RP income now — passive regen (see main.gd) is just a small
...
@onready var body: CircleShape = $Body
