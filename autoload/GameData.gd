...
const DEFENDER_STATS := {
	...
	DefenderType.HELPER_T: {"hp": 20.0, "power": 0.0, "attack_rate": 0.0, "range": 2, "cost": 35, "color": Color8(230, 190, 90), "aura_power_buff": 0.25},
	DefenderType.DENDRITIC: {"hp": 15.0, "power": 0.0, "attack_rate": 0.0, "range": 2, "cost": 35, "color": Color8(130, 140, 220), "aura_mark_damage": 0.25},
}

const ENEMY_STATS := {
	EnemyType.BACTERIA: {"hp": 32.0, "power": 7.0, "attack_rate": 1.0, "move_speed": 0.4, "contact_damage": 7.0, "color": Color8(140, 190, 60), "sprite": "res://art/enemies/bacteria_idle.png", "attack_sprites": ["res://art/enemies/bacteria_attack_1.png", "res://art/enemies/bacteria_attack_2.png"], "die_sprites": ["res://art/enemies/bacteria_die.png"]},
	EnemyType.VIRUS: {"hp": 18.0, "power": 8.0, "attack_rate": 1.3, "move_speed": 0.6, "contact_damage": 8.0, "color": Color8(200, 80, 190)},
	...
	EnemyType.STAPH: {"hp": 18.0, "power": 4.0, "attack_rate": 1.0, "move_speed": 0.4, "contact_damage": 4.0, "spawn_group": 2, "color": Color8(210, 175, 50), "sprite": "res://art/enemies/staph_idle.png", "attack_sprites": ["res://art/enemies/staph_attack_1.png", "res://art/enemies/staph_attack_2.png"], "die_sprites": ["res://art/enemies/staph_die.png"]},
	...
	# single-target defender if it's left unengaged near the front.
	EnemyType.STREP: {"hp": 16.0, "power": 6.0, "attack_rate": 1.2, "move_speed": 0.75, "contact_damage": 6.0, "color": Color8(205, 90, 80), "sprite": "res://art/enemies/strep_idle.png", "attack_sprites": ["res://art/enemies/strep_attack_1.png", "res://art/enemies/strep_attack_2.png"], "die_sprites": ["res://art/enemies/strep_die.png"]},
}
...
const LEVELS := {
	1: {
		"name": "Skin — The Wound",
		"duration": 60.0, "base_interval": 2.6, "interval_decay": 0.04, "interval_floor": 0.7,
		"starting_rp": 55.0,
